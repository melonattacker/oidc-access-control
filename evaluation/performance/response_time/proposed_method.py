...
async def main():
    async with async_playwright() as p:
        ...
        for i in range(100):
            ...
            print(f"Response time for {i}: {response_time:.2f} seconds")
        ...
        save_to_csv(response_times_sign_in, filename="./data/performance/proposed_method/response_times_sign_in.csv")
        save_to_csv(response_times_after_sign_in, filename="./data/performance/proposed_method/response_times_after_sign_in.csv")
