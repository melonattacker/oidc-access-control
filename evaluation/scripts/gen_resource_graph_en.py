...
# CPU使用率のグラフを描画 & 保存
plot_and_save_graph(labels, cpu_values, cpu_errors, 'CPU Usage [%]', './evaluation/graph/cpu_usage_comparison_en.png', legend_labels)

# メモリ使用量のグラフを描画 & 保存
plot_and_save_graph(labels, mem_values, mem_errors, 'Memory Usage [MB]', './evaluation/graph/memory_usage_comparison_en.png', legend_labels)